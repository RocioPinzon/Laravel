        ...
        <header class="bg-red-500 py-6">
            <div class="container mx-auto flex justify-between items-center px-6">
                ...
                @auth   
                    ...
                    <a href="{{route('mailgmail.sendEmail')}}" class="text-lg font-semibold text-gray-100 no-underline">
                        {{ __("ContactaGmail") }}
                    </a>
                @endauth

                <!--@if (auth::check() and Auth::user() )
                            <a class="no-underline hover:underline" href="{{ route('register') }}">{{ __('Panel de administrador') }}</a>
                @endif-->
